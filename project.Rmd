...
#fitting lm
# ask about price variable, missing value
library(broom)
...
fit1 <- glm(y~., data=mutate(training,
                                   y=stars==1),family="binomial")
fit2 <- glm(y~., data=mutate(training,
                                   y=stars==1.5),family="binomial")
fit3 <- glm(y~., data=mutate(training,
                                   y=stars==2),family="binomial")
fit4 <- glm(y~., data=mutate(training,
                                   y=stars==2.5),family="binomial")
fit5<- glm(y~., data=mutate(training,
                                   y=stars==3),family="binomial")
fit6 <- glm(y~., data=mutate(training,
                                   y=stars==3.5),family="binomial")
fit7 <- glm(y~., data=mutate(training,
                                   y=stars==4),family="binomial")
fit8 <- glm(y~., data=mutate(training,
                                   y=stars==4.5),family="binomial")
fit9 <- glm(y~., data=mutate(training,
                                   y=stars==5),family="binomial")


f_hat1 <- predict(fit1, newdata = testing, type = "response")
f_hat2 <- predict(fit2, newdata = testing, type ="response")
f_hat3 <- predict(fit3, newdata = testing, type = "response")
f_hat4 <- predict(fit4, newdata = testing, type ="response")
f_hat5 <- predict(fit5, newdata = testing, type = "response")
f_hat6 <- predict(fit6, newdata = testing, type ="response")
f_hat7 <- predict(fit7, newdata = testing, type = "response")
f_hat8 <- predict(fit8, newdata = testing, type ="response")
f_hat9 <- predict(fit9, newdata = testing, type = "response")
...
res
# fit with k=19
fit <- knn3(stars~., data=training, k=19)
f_hat <- predict(fit, newdata = testing)
...
library(e1071)
fit_svm <- svm(stars~.,data=training) 
pred_svm <-predict(fit_svm,newdata=testing)

# Random Forest
library(randomForest)
fit_rr<-randomForest(stars~.,data=training)
pred_rr<-predict(fit_rr,newdata=testing)
```
