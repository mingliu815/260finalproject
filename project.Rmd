...
tempB <- review%>%select(business_id)
...
training1 <- slice(business_data1, inTrain1$Resample1)
testing1 <- slice(business_data1, -inTrain1$Resample1)
...
training <- slice(business_data, inTrain1$Resample1)
testing <- slice(business_data, -inTrain1$Resample1)
```
